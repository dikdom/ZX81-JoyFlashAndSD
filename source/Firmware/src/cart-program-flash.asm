 ...
 * I print out the menu border and check if there is
 * SD card in slot. If yes, I jump there otherwise
 * continue with flash usage.
 */
 
WINDOW_HEIGHT EQU 16
WINDOW_POS EQU $7A00       ; DW
...
LAST_FRAME        EQU CURRENT_DIR_FADDR + 3 ;


ON_SCREEN_ENTRIES EQU $B000
ifdef DEBUG
REPEAT_KEY_COUNTER_FIRST EQU $0e
REPEAT_KEY_COUNTER_SECOND EQU $06
else
REPEAT_KEY_COUNTER_FIRST EQU $10
REPEAT_KEY_COUNTER_SECOND EQU $0a
...
;  ld hl, (RAMTOP)
  ...
  LD      HL,($4004)      ; fetch system variable RAMTOP.
...
.read_header_loop
  call W25Q_READ_DATA
  cp (hl)
  jr nz, .invalid_header_found
  inc hl
  djnz .read_header_loop
  ret
.invalid_header_found
  call .clear_menu_area
.blink_loop
  call .print_no_flash_content
  ld a, (1<<SPI_CS) + (1<<SD_SPI_CS) + (1<<SPI_DI)
  out (CTRL_PORT), A
  call .some_delay
  call .clear_menu_area
  ld a, (1<<SPI_CS) + (1<<SD_SPI_CS) + (1<<SPI_DI) + (1<<SPI_CLK)
  out (CTRL_PORT), A
  call .some_delay
  jr .blink_loop
.some_delay
...
.clear_menu_area
  ...
  add hl, de
  ld b, 16
.print_next_line_loop
  ld c, 32
.print_one_line_loop
  ld (hl), a
  inc hl
  dec C
  jr nz, .print_one_line_loop
  inc hl
  djnz .print_next_line_loop
  ret
.print_no_flash_content
  ld hl, NO_FLASH_FOUND_STR
  ld bc, 10:2
  call OWN_PRINT_AT
  ret
...
NO_FLASH_FOUND_STR:
  ...
  db _N, _O, __, _V, _A, _L, _I, _D, __, _F, _L, _A, _S, _H, __, _C, _O, _N, _T, _E, _N, _T, __, _F, _O, _U, _N, _D, $FF
...
PRINT_FLASH_SIZE
  ld b, 23
  ld c, 17
  ld hl, SCREEN_FOOTER3_FLASH_STR
  call OWN_PRINT_AT
  call GET_FLASH_SIZE
  SLA A
  ld e,a
...
;  DB _Z, _X, _8, _1, __, __, _F, _L, _A, _S, _H, _PLUS, _J, _O, _Y, __, _E, _X, _P, _A, _N, _S, _I, _O, _N, __, _C, _A, _R, _T, $FF
  DB _Z, _X, _8, _1, __, _F, _L, _A, _S, _H, _PLUS, _S, _D, _PLUS, _J, _O, _Y, __, _E, _X, _P, _A, _N, _S, _I, _O, _N, __, _C, _A, _R, _T, $FF
SCREEN_HEADER2_STR:
  DB _B, _Y, __, _S, _A, _N, _Y, _I, _COMMA, __, _V, _X, _PERIOD, _X, _X, _COMMA, __, _2, _0, _2, _4, $FF
...
SCREEN_FOOTER3_STR:
  DB _P, _R, _E, _S, _S, __, _1, __, _T, _O, __, _B, _A, _S, _I, _C, $FF
SCREEN_FOOTER3_FLASH_STR:
  DB __, __, __, __, _F, _L, _A, _S, _H, _COLON, __, __, __, _M, _B, $FF
...
; 0|ZX81 FLASH+SD+JOY EXPANSION CART|
;  |           BY SANYI, V1.00, 2023|
;  |                                |
;  | --------=NAME=-------+--SIZE-- |
; 4| FIRST PROGRAM                2 |
